...
\NormalTok{result <-}\StringTok{ }\KeywordTok{Proposed_Aggreg}\NormalTok{(}\DataTypeTok{k =} \DecValTok{50}\NormalTok{, }\DataTypeTok{SNP_names =}\NormalTok{ obj.bigSNP}\OperatorTok{$}\NormalTok{map}\OperatorTok{$}\NormalTok{marker.ID[indx], }\DataTypeTok{Gusing =}\NormalTok{ G_using, }\DataTypeTok{POS_using =}\NormalTok{ POS_using, }\DataTypeTok{CHR_using =}\NormalTok{ CHR_using, }\DataTypeTok{effective_gene =}\NormalTok{ POS_EFF, }\DataTypeTok{bE =} \FloatTok{0.3}\NormalTok{, }\DataTypeTok{bint =} \FloatTok{0.3}\NormalTok{, }\DataTypeTok{bG =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{sigmaE =} \DecValTok{1}\NormalTok{, }\DataTypeTok{sigma_eps =} \FloatTok{0.5}\NormalTok{)}
\KeywordTok{manhattan}\NormalTok{(result, }\DataTypeTok{highlight =}\NormalTok{ result_P_INT}\OperatorTok{$}\NormalTok{SNP[}\KeywordTok{which}\NormalTok{(POS_using }\OperatorTok{%in%}\StringTok{ }\NormalTok{POS_EFF)], }\DataTypeTok{suggestiveline =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{genomewideline =} \OperatorTok{-}\KeywordTok{log10}\NormalTok{(}\DecValTok{5} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{-8}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\includegraphics{stats-gene-research-progress-v8_files/figure-latex/Agg-1.png}
...
\includegraphics{stats-gene-research-progress-v8_files/figure-latex/Agg-2.png}
...
\includegraphics{stats-gene-research-progress-v8_files/figure-latex/Agg-3.png}
...
\includegraphics{stats-gene-research-progress-v8_files/figure-latex/unnamed-chunk-4-1.png}
...
\KeywordTok{sort}\NormalTok{(MAF[POS_using }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(POS_EFF1,POS_EFF2,POS_EFF3, POS_EFF4, POS_EFF5, POS_EFF6)])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{## Table:}
\NormalTok{power <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(}\KeywordTok{rbind}\NormalTok{(power1,power2,power3, power4,power5,power6))) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{MAF =} \KeywordTok{sort}\NormalTok{(MAF[POS_using }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(POS_EFF1,POS_EFF2,POS_EFF3,POS_EFF4,POS_EFF5,POS_EFF6)]))}
...
\begin{Highlighting}[]
\CommentTok{## Figure:}
\NormalTok{power }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pivot_longer}\NormalTok{(proposed}\OperatorTok{:}\NormalTok{oracle_error, }\StringTok{"Type"}\NormalTok{, }\DataTypeTok{values_to =} \StringTok{"Power"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(MAF,Power,}\DataTypeTok{color =}\NormalTok{ Type)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{### show their corresponding MAF:}
\KeywordTok{sort}\NormalTok{(MAF[POS_using }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(POS_EFF1,POS_EFF2,POS_EFF3)])}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] 0.09491138 0.19725557 0.41966838
\end{verbatim}
...
\CommentTok{#1:}
\NormalTok{error1 <-}\StringTok{ }\KeywordTok{Compare_Aggreg_type1_error}\NormalTok{(}\DataTypeTok{SNP_names =}\NormalTok{ obj.bigSNP}\OperatorTok{$}\NormalTok{map}\OperatorTok{$}\NormalTok{marker.ID[indx], }\DataTypeTok{G_using =}\NormalTok{ G_using, }\DataTypeTok{POS_using =}\NormalTok{ POS_using, }\DataTypeTok{CHR_using =}\NormalTok{ CHR_using, }\DataTypeTok{effective_gene =}\NormalTok{ POS_EFF1, }\DataTypeTok{bE =} \FloatTok{0.3}\NormalTok{, }\DataTypeTok{bint =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{bG =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{sigmaE =} \DecValTok{1}\NormalTok{, }\DataTypeTok{sigma_eps =} \FloatTok{0.5}\NormalTok{)}
\NormalTok{error1 <-}\StringTok{ }\NormalTok{error1 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(BP }\OperatorTok{!=}\StringTok{ }\NormalTok{POS_EFF1) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(P}\OperatorTok{:}\NormalTok{oracle_error)}
\NormalTok{r1 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(error1}\OperatorTok{<=}\StringTok{ }\DecValTok{5} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{-2}\NormalTok{), }\DecValTok{2}\NormalTok{, mean)}


\CommentTok{#3:}
\NormalTok{error2 <-}\StringTok{ }\KeywordTok{Compare_Aggreg_type1_error}\NormalTok{(}\DataTypeTok{SNP_names =}\NormalTok{ obj.bigSNP}\OperatorTok{$}\NormalTok{map}\OperatorTok{$}\NormalTok{marker.ID[indx], }\DataTypeTok{G_using =}\NormalTok{ G_using, }\DataTypeTok{POS_using =}\NormalTok{ POS_using, }\DataTypeTok{CHR_using =}\NormalTok{ CHR_using, }\DataTypeTok{effective_gene =}\NormalTok{ POS_EFF2, }\DataTypeTok{bE =} \FloatTok{0.3}\NormalTok{, }\DataTypeTok{bint =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{bG =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{sigmaE =} \DecValTok{1}\NormalTok{, }\DataTypeTok{sigma_eps =} \FloatTok{0.5}\NormalTok{)}
\NormalTok{error2 <-}\StringTok{ }\NormalTok{error2 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(BP }\OperatorTok{!=}\StringTok{ }\NormalTok{POS_EFF2) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(P}\OperatorTok{:}\NormalTok{oracle_error)}
\NormalTok{r2 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(error2}\OperatorTok{<=}\DecValTok{5} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{-2}\NormalTok{), }\DecValTok{2}\NormalTok{, mean)}

\CommentTok{#5:}
\NormalTok{error3 <-}\StringTok{ }\KeywordTok{Compare_Aggreg_type1_error}\NormalTok{(}\DataTypeTok{SNP_names =}\NormalTok{ obj.bigSNP}\OperatorTok{$}\NormalTok{map}\OperatorTok{$}\NormalTok{marker.ID[indx], }\DataTypeTok{G_using =}\NormalTok{ G_using, }\DataTypeTok{POS_using =}\NormalTok{ POS_using, }\DataTypeTok{CHR_using =}\NormalTok{ CHR_using, }\DataTypeTok{effective_gene =}\NormalTok{ POS_EFF3, }\DataTypeTok{bE =} \FloatTok{0.3}\NormalTok{, }\DataTypeTok{bint =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{bG =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{sigmaE =} \DecValTok{1}\NormalTok{, }\DataTypeTok{sigma_eps =} \FloatTok{0.5}\NormalTok{)}
\NormalTok{error3 <-}\StringTok{ }\NormalTok{error3 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(BP }\OperatorTok{!=}\StringTok{ }\NormalTok{POS_EFF3) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(P}\OperatorTok{:}\NormalTok{oracle_error)}
\NormalTok{r3 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(error3}\OperatorTok{<=}\DecValTok{5} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{-2}\NormalTok{), }\DecValTok{2}\NormalTok{, mean)}


\NormalTok{r <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(}\KeywordTok{rbind}\NormalTok{(r1,r2,r3))}
\NormalTok{r}\OperatorTok{$}\NormalTok{MAF <-}\StringTok{ }\KeywordTok{sort}\NormalTok{(MAF[POS_using }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(POS_EFF1,POS_EFF2,POS_EFF3)])}
\NormalTok{r }\OperatorTok{%>%}\StringTok{ }\KeywordTok{rename}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"proposed"}\NormalTok{ =}\StringTok{ "P"}\NormalTok{,}\StringTok{"oracle"}\NormalTok{ =}\StringTok{ "oracle_p"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pivot_longer}\NormalTok{(proposed}\OperatorTok{:}\NormalTok{oracle_error, }\StringTok{"Type"}\NormalTok{, }\DataTypeTok{values_to =} \StringTok{"Error"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(MAF,Error,}\DataTypeTok{color =}\NormalTok{ Type)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Type I Error"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_hline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{yintercept =} \FloatTok{0.05}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all_error <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(error3}\OperatorTok{<=}\FloatTok{0.05}\NormalTok{)}
\NormalTok{all_error <-}\StringTok{ }\NormalTok{all_error }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{MAF =}\NormalTok{ MAF[}\OperatorTok{!}\NormalTok{POS_using }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(POS_EFF5)])}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.1}\NormalTok{, }\StringTok{"0.1-0.2"}\NormalTok{,}\StringTok{"0.05-0.1"}\NormalTok{)}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.2}\NormalTok{, }\StringTok{"0.2-0.3"}\NormalTok{, all_error}\OperatorTok{$}\NormalTok{MAF_level)}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.3}\NormalTok{, }\StringTok{"0.3-0.4"}\NormalTok{, all_error}\OperatorTok{$}\NormalTok{MAF_level)}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.4}\NormalTok{, }\StringTok{"0.4-0.5"}\NormalTok{, all_error}\OperatorTok{$}\NormalTok{MAF_level)}


\NormalTok{all_error <-}\StringTok{ }\NormalTok{all_error }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(MAF_level) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{proposed =} \KeywordTok{mean}\NormalTok{(P), }\DataTypeTok{oracle =} \KeywordTok{mean}\NormalTok{(oracle_p), }\DataTypeTok{oracle_error =} \KeywordTok{mean}\NormalTok{(oracle_error), }\DataTypeTok{number =} \KeywordTok{n}\NormalTok{())}
...
\includegraphics{stats-gene-research-progress-v8_files/figure-latex/unnamed-chunk-7-1.png}
...
\includegraphics{stats-gene-research-progress-v8_files/figure-latex/unnamed-chunk-7-2.png}
...
\begin{Highlighting}[]
\CommentTok{## Figure:}
\NormalTok{power }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pivot_longer}\NormalTok{(proposed_}\DecValTok{1}\OperatorTok{:}\NormalTok{oracle_error, }\StringTok{"Type"}\NormalTok{, }\DataTypeTok{values_to =} \StringTok{"Power"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(MAF,Power,}\DataTypeTok{color =}\NormalTok{ Type)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
proposed\_1 & proposed\_2 & oracle & oracle\_error & MAF\\
\hline
0.055 & 0.795 & 1 & 1 & 0.0949114\\
\hline
0.180 & 0.935 & 1 & 1 & 0.1415094\\
\hline
0.480 & 0.975 & 1 & 1 & 0.1861063\\
\hline
0.565 & 0.995 & 1 & 1 & 0.2052601\\
\hline
0.830 & 0.975 & 1 & 1 & 0.3750715\\
\hline
0.845 & 0.980 & 1 & 1 & 0.4385363\\
\hline
\end{tabular}
\end{table}
...
\CommentTok{### Compute type I error rate of each case:}
\CommentTok{#1:}
\KeywordTok{suppressWarnings}\NormalTok{(error1 <-}\StringTok{ }\KeywordTok{Compare_Aggreg_type1_error_auxiliary}\NormalTok{(}\DataTypeTok{G_using =}\NormalTok{ G_using, }\DataTypeTok{POS_using =}\NormalTok{ POS_using, }\DataTypeTok{effective_gene =}\NormalTok{ POS_EFF1, }\DataTypeTok{bE =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{bint =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{bG =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{sigmaE =} \DecValTok{1}\NormalTok{, }\DataTypeTok{sigma_eps =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{MAF =}\NormalTok{ MAF))}
\NormalTok{r1 <-}\StringTok{ }\NormalTok{error1 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(BP }\OperatorTok{!=}\StringTok{ }\NormalTok{POS_EFF1) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(proposed_}\DecValTok{1}\OperatorTok{:}\NormalTok{oracle_error)}
\NormalTok{r1 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(r1}\OperatorTok{<=}\StringTok{ }\DecValTok{5} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{-2}\NormalTok{), }\DecValTok{2}\NormalTok{, mean)}


\CommentTok{#3:}
\KeywordTok{suppressWarnings}\NormalTok{(error2 <-}\StringTok{ }\KeywordTok{Compare_Aggreg_type1_error_auxiliary}\NormalTok{(}\DataTypeTok{G_using =}\NormalTok{ G_using, }\DataTypeTok{POS_using =}\NormalTok{ POS_using, }\DataTypeTok{effective_gene =}\NormalTok{ POS_EFF2, }\DataTypeTok{bE =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{bint =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{bG =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{sigmaE =} \DecValTok{1}\NormalTok{, }\DataTypeTok{sigma_eps =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{MAF =}\NormalTok{ MAF))}
\NormalTok{r2 <-}\StringTok{ }\NormalTok{error2 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(BP }\OperatorTok{!=}\StringTok{ }\NormalTok{POS_EFF2) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(proposed_}\DecValTok{1}\OperatorTok{:}\NormalTok{oracle_error)}
\NormalTok{r2 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(r2}\OperatorTok{<=}\DecValTok{5} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{-2}\NormalTok{), }\DecValTok{2}\NormalTok{, mean)}

\CommentTok{#5:}
\KeywordTok{suppressWarnings}\NormalTok{(error3 <-}\StringTok{ }\KeywordTok{Compare_Aggreg_type1_error_auxiliary}\NormalTok{(}\DataTypeTok{G_using =}\NormalTok{ G_using, }\DataTypeTok{POS_using =}\NormalTok{ POS_using, }\DataTypeTok{effective_gene =}\NormalTok{ POS_EFF3, }\DataTypeTok{bE =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{bint =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{bG =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{sigmaE =} \DecValTok{1}\NormalTok{, }\DataTypeTok{sigma_eps =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{MAF =}\NormalTok{ MAF))}
\NormalTok{r3 <-}\StringTok{ }\NormalTok{error3 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(BP }\OperatorTok{!=}\StringTok{ }\NormalTok{POS_EFF3) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(proposed_}\DecValTok{1}\OperatorTok{:}\NormalTok{oracle_error)}
\NormalTok{r3 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(r3}\OperatorTok{<=}\DecValTok{5} \OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{-2}\NormalTok{), }\DecValTok{2}\NormalTok{, mean)}


\NormalTok{r <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(}\KeywordTok{rbind}\NormalTok{(r1,r2,r3))}
\NormalTok{r}\OperatorTok{$}\NormalTok{MAF <-}\StringTok{ }\KeywordTok{sort}\NormalTok{(MAF[POS_using }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(POS_EFF1,POS_EFF2,POS_EFF3)])}
\NormalTok{r }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pivot_longer}\NormalTok{(proposed_}\DecValTok{1}\OperatorTok{:}\NormalTok{oracle_error, }\StringTok{"Type"}\NormalTok{, }\DataTypeTok{values_to =} \StringTok{"Error"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(MAF,Error,}\DataTypeTok{color =}\NormalTok{ Type)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Type I Error"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_hline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{yintercept =} \FloatTok{0.05}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{stats-gene-research-progress-v8_files/figure-latex/unnamed-chunk-10-1.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all_error <-}\StringTok{ }\NormalTok{error3 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{proposed_1 =}\NormalTok{ proposed_}\DecValTok{1}\OperatorTok{<=}\FloatTok{0.05}\NormalTok{, }\DataTypeTok{proposed_2 =}\NormalTok{ proposed_}\DecValTok{2}\OperatorTok{<=}\FloatTok{0.05}\NormalTok{, }\DataTypeTok{oracle_p =}\NormalTok{ oracle_p}\OperatorTok{<=}\FloatTok{0.05}\NormalTok{, }\DataTypeTok{oracle_error =}\NormalTok{ oracle_error}\OperatorTok{<=}\FloatTok{0.05}\NormalTok{)}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.1}\NormalTok{, }\StringTok{"0.1-0.2"}\NormalTok{,}\StringTok{"0.05-0.1"}\NormalTok{)}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.2}\NormalTok{, }\StringTok{"0.2-0.3"}\NormalTok{, all_error}\OperatorTok{$}\NormalTok{MAF_level)}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.3}\NormalTok{, }\StringTok{"0.3-0.4"}\NormalTok{, all_error}\OperatorTok{$}\NormalTok{MAF_level)}
\NormalTok{all_error}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(all_error}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.4}\NormalTok{, }\StringTok{"0.4-0.5"}\NormalTok{, all_error}\OperatorTok{$}\NormalTok{MAF_level)}
...
the expected range, regardless of the MAF level.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{error3}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(error3}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.1}\NormalTok{, }\StringTok{"0.1-0.2"}\NormalTok{,}\StringTok{"0.05-0.1"}\NormalTok{)}
\NormalTok{error3}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(error3}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.2}\NormalTok{, }\StringTok{"0.2-0.3"}\NormalTok{, error3}\OperatorTok{$}\NormalTok{MAF_level)}
\NormalTok{error3}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(error3}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.3}\NormalTok{, }\StringTok{"0.3-0.4"}\NormalTok{, error3}\OperatorTok{$}\NormalTok{MAF_level)}
\NormalTok{error3}\OperatorTok{$}\NormalTok{MAF_level <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(error3}\OperatorTok{$}\NormalTok{MAF }\OperatorTok{>=}\StringTok{ }\FloatTok{0.4}\NormalTok{, }\StringTok{"0.4-0.5"}\NormalTok{, error3}\OperatorTok{$}\NormalTok{MAF_level)}
\NormalTok{error3 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pivot_longer}\NormalTok{(proposed_}\DecValTok{1}\OperatorTok{:}\NormalTok{oracle_error, }\DataTypeTok{names_to =} \StringTok{"Type"}\NormalTok{, }\DataTypeTok{values_to =} \StringTok{"p_value"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ p_value, }\DataTypeTok{fill =}\NormalTok{ Type)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{bins =} \DecValTok{5}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{facet_grid}\NormalTok{(}\OperatorTok{~}\NormalTok{MAF_level)}
\end{Highlighting}
\end{Shaded}

\includegraphics{stats-gene-research-progress-v8_files/figure-latex/unnamed-chunk-12-1.png}
